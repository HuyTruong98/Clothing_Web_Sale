...
router.post('/', uploadFile, validate(productValidation.createProduct), productController.createProduct);

router.get('/:id', productController.getProductId);
router.patch('/:id', uploadFile, validate(productValidation.updateProduct), productController.updateProduct);
router.delete('/:id', validate(productValidation.deleteProduct), productController.deleteProduct);
router.get('/', validate(productValidation.getAllProduct), productController.getAllProduct);
 ...
 *      description: Only admins can fetch other products.
 *      tags: [Products]
 *      security:
 *        - bearerAuth: []
 *      parameters:
 ...
 *      description: Only admins can delete other products.
 *      tags: [Products]
 *      security:
 *        - bearerAuth: []
 *      parameters:
